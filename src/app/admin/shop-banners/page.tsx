...
export default function AdminShopBannersPage() {
    ...
    const createBanner = async () => {
        ...
        formData.append("teaType", teaType);
                ...
                <div className="rounded-[28px] border border-black/10 bg-white p-6 shadow-sm">
                    ...
                    <div className="mt-6 space-y-5">
                                ...
                                <div className="relative overflow-hidden rounded-3xl border border-dashed border-black/15 bg-bg-surface p-4 transition hover:border-brand-primary/30 hover:bg-brand-primary/5">
                                    ...
                                    <div className="flex min-h-32 flex-col items-center justify-center text-center">
                                        ...
                                        <p className="mt-2 text-xs font-medium text-text-primary">
                                            {imageFile ? imageFile.name : "Desktop Version"}
                                        </p>
                                    </div>
                                </div>
                            </label>
                            ...
                            <label className="block">
                                ...
                                <div className="relative overflow-hidden rounded-3xl border border-dashed border-black/15 bg-bg-surface p-4 transition hover:border-brand-primary/30 hover:bg-brand-primary/5">
                                    ...
                                    <div className="flex min-h-32 flex-col items-center justify-center text-center">
                                        <ImagePlus className="h-5 w-5 text-text-secondary" />
                                        <p className="mt-2 text-xs font-medium text-text-primary">
                                            {mobileImageFile ? mobileImageFile.name : "Mobile Version"}
                                        </p>
                                    </div>
                                </div>
                            </label>
                        ...
                        <div className="space-y-2">
                            ...
                            <select
                                className="w-full rounded-xl border border-black/10 bg-white px-4 py-3 text-sm text-text-primary outline-none focus:border-brand-primary"
                                value={teaType}
                                onChange={(e) => setTeaType(e.target.value)}
                            >
                                <option value="">Generic (All Shop)</option>
                                {TEA_TYPES.map(type => (
                                            ...
                                            <div className="relative aspect-16/10 w-full overflow-hidden">
                                                ...
                                                <div className="absolute inset-x-0 bottom-0 p-4 text-white">
                                                    <div className="flex items-center gap-2 mb-1">
                                                        ...
                                                        {banner.teaType && (
                                                            <span className="text-[10px] bg-brand-primary/80 px-1.5 py-0.5 rounded text-white uppercase tracking-wider">
                                                                {banner.teaType}
                                                            </span>
                                                        )}
                                                    </div>
